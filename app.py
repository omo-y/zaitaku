...
'''
【前提】
seoコピーライティングのターゲットユーザーは「在宅で営業サポートや営業アシスタントに取り組もうと考えている人」とする。
最初に、在宅での営業サポートや営業アシスタントの仕事内容を紹介してください。
在宅で営業サポートや営業アシスタントに取り組もうと考えている人に役に立つ情報を具体的に挙げて詳細に解説してください。
